...
export const routerMap = [
  ...
  },
  {
    ...
    name: 'crm',
    component: Layout,
    meta: { index: 1, title: '客户关系管理', icon: 'ios-settings' },
    children: [
      {
        path: 'rfm/update',
        name: 'rfm_update',
        component: () => import('@/views/crm/rfm/demo'),
        meta: { index: 2, title: 'RFM 更新', icon: 'ios-person' }
      },
      {
        path: 'rfm/management',
        name: 'rfm_management',
        component: () => import('@/views/crm/rfm'),
...
export const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/login/findpwd-form.vue'),
        meta: { index: 0, title: '忘记密码' }
      },
      {
        path: 'captchaTest',
        name: 'captchaTest',
        component: () => import('@/views/login/revisepwd-form.vue'),
        meta: { index: 0, title: 'a标签验证测试' }
      },
      {
        path: 'redirect',
        name: 'redirect',
